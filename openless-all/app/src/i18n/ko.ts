...
export const ko: typeof zhCN = {
  ...
  style: {
    ...
    packs: {
      kicker: 'STYLE PACKS',
      title: '스타일 팩',
      desc: '로컬 스타일 팩을 관리합니다.',
      loadFailed: '스타일 팩 불러오기 실패: {{message}}',
      importZip: 'ZIP 가져오기',
      exportZip: 'ZIP 내보내기',
      exportShort: '내보내기',
      builtin: '내장',
      ...
      unsaved: '미저장',
      listTitle: '로컬 팩',
      listDesc: '팩을 둘러보고 전환합니다.',
      listCount: '{{count}}개 팩',
      save: '저장',
      revert: '되돌리기',
      saveSuccess: '스타일 팩을 저장했습니다.',
      saveFailed: '스타일 팩 저장 실패: {{message}}',
      activateSuccess: '"{{name}}"을(를) 현재 스타일로 설정했습니다.',
      activateFailed: '현재 스타일 설정 실패: {{message}}',
      enableSuccess: '"{{name}}"을(를) 로테이션에 추가했습니다.',
      disableSuccess: '"{{name}}"을(를) 로테이션에서 제외했습니다.',
      toggleFailed: '로테이션 상태 변경 실패: {{message}}',
      importSuccess: '"{{name}}"을(를) 가져왔습니다.',
      importFailed: 'ZIP 가져오기 실패: {{message}}',
      exportSuccess: '{{path}}로 내보냈습니다',
      exportFailed: 'ZIP 내보내기 실패: {{message}}',
      exportDirtyFirst: 'ZIP 내보내기 전에 이 팩을 먼저 저장하세요.',
      resetBuiltin: '초기화',
      resetSuccess: '"{{name}}"을(를) 초기화했습니다.',
      resetFailed: '팩 초기화 실패: {{message}}',
      deleteImported: '삭제',
      deleteConfirm: '"{{name}}"을(를) 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
      deleteSuccess: '"{{name}}"을(를) 삭제했습니다.',
      deleteFailed: '팩 삭제 실패: {{message}}',
      summaryBuiltin: '내장 팩',
      summaryBuiltinHint: '제품 기본 의미 체계. 한 번에 초기화할 수 있습니다.',
      summaryImported: '가져온 팩',
      summaryImportedHint: 'ZIP에서 설치되며 이식 가능합니다.',
      summaryEnabled: '로테이션 포함',
      summaryCurrent: '현재: {{name}}',
      summaryCurrentEmpty: '아직 선택된 팩이 없습니다',
      editorTitle: '팩 편집',
      ...
      metaBaseMode: '기본 모드',
      metaStatus: '로테이션',
      metaUpdatedAt: '업데이트 시각',
      fieldName: '이름',
      fieldAuthor: '작성자',
      fieldAuthorPlaceholder: '선택 사항: 출처 라벨',
      fieldVersion: '버전',
      fieldTags: '태그',
      fieldTagsPlaceholder: '쉼표로 구분, 예: community, voiceover, formal',
      fieldDescription: '설명',
      fieldModel: '권장 모델( Metadata )',
      fieldModelPlaceholder: '선택 사항, 예: gpt-4.1 / deepseek-v3',
      fieldModelHint: 'Metadata 용도이며 실제 모델은 전환되지 않습니다.',
      fieldCompatibility: '호환 앱 버전',
      fieldCompatibilityPlaceholder: '선택 사항, 예: >=1.3.0',
      fullPromptTitle: 'System Prompt',
      fullPromptHint: '이 팩 전용 Prompt입니다.',
      runtimeTitle: 'OpenLess 실행 시 추가 지시',
      runtimeDesc: '읽기 전용 실행 보조 정보입니다.',
      runtimeDirectiveContextTitle: '컨텍스트 전제',
      runtimeDirectiveContextDesc: '언어 및 앱 컨텍스트에서 생성',
      runtimeDirectiveContextEmpty: '현재 프리뷰에는 추가되지 않습니다.',
      runtimeDirectiveHotwordTitle: '핫워드 블록',
      runtimeDirectiveHotwordDesc: '활성화된 핫워드에서 생성',
      runtimeDirectiveHotwordEmpty: '현재 프리뷰에는 추가되지 않습니다.',
      runtimeDirectiveHistoryTitle: '다중 턴 이력 가드레일',
      runtimeDirectiveHistoryDesc: '실시간 다중 턴 polish 전용',
      runtimeDirectiveHistoryEmpty: 'prior turns가 있을 때만 추가됩니다.',
      runtimeDirectiveActive: '활성',
      runtimeDirectiveInactive: '비활성',
      runtimePreviewFailed: '실행 프리뷰 생성 실패: {{message}}',
      runtimePreviewOmittedFrontApp: '프리뷰에서는 전면 앱 라벨을 생략합니다.',
      examplesTitle: '효과 예시',
      ...
      promptCharCount: '{{count}}자',
      discardCloseConfirm: '저장하지 않은 변경을 버리고 편집기를 닫을까요?',
      discardSwitchConfirm: '저장하지 않은 변경을 버리고 "{{name}}"으로 전환할까요?',
    },
  },
  translation: {
    kicker: 'TRANSLATION',
